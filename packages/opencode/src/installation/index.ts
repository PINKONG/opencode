    ...
    Effect.gen(function* () {
      ...
      const methodImpl = Effect.fn("Installation.method")(function* () {
        ...
        for (const check of checks) {
          ...
          const installedName = check.name === "brew" || check.name === "choco" || check.name === "scoop" ? win : npm
      ...
      const latestImpl = Effect.fn("Installation.latest")(function* (installMethod?: Method) {
        ...
        if (detectedMethod === "npm" || detectedMethod === "bun" || detectedMethod === "pnpm") {
          ...
          const response = yield* httpOk.execute(
            HttpClientRequest.get(`${registry}/${npm}/${InstallationChannel}`).pipe(HttpClientRequest.acceptJson),
          )
        ...
        switch (m) {
          ...
          case "brew": {
            ...
            if (formula.includes("/")) {
              ...
              const repo = yield* text(["brew", "--repo", "PINKONG/tap"])
              const dir = repo.trim()
              if (dir) {
