  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all WisCode sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific WisCode session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new WisCode session for interacting with AI assistants and managing conversations.",
