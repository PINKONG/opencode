...
describe("public surface branding", () => {
  ...
  test("zed extension metadata points to WisCode releases", async () => {
    ...
    expect(ext).toContain('version = "1.0.3"')
    expect(ext).toContain('repository = "https://github.com/PINKONG/opencode"')
    expect(ext).toContain("[agent_servers.wiscode]")
    expect(ext).toContain('archive = "https://github.com/PINKONG/opencode/releases/download/v1.0.3/wiscode-cli-darwin-arm64.zip"')
    expect(ext).toContain('archive = "https://github.com/PINKONG/opencode/releases/download/v1.0.3/wiscode-cli-darwin-x64.zip"')
    expect(ext).toContain('archive = "https://github.com/PINKONG/opencode/releases/download/v1.0.3/wiscode-cli-linux-arm64.tar.gz"')
    expect(ext).toContain('archive = "https://github.com/PINKONG/opencode/releases/download/v1.0.3/wiscode-cli-linux-x64.tar.gz"')
    expect(ext).toContain('archive = "https://github.com/PINKONG/opencode/releases/download/v1.0.3/wiscode-cli-windows-x64.zip"')
