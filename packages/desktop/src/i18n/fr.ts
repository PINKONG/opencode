export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'WisCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'WisCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.menu.help.documentation": "Documentation d'WisCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI WisCode est manquant. Essayez de réinstaller l'application de bureau.",
