export const dict = {
  ...
  "desktop.menu.help.documentation": "WisCode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "WisCode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
