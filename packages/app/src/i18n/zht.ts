...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "WisCode 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 WisCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 WisCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 WisCode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 wiscode.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 WisCode 伺服器。",
  ...
  "toast.update.description": "WisCode 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 WisCode 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (wiscode.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: WisCode 暫不支援 MCP 認證。',
  ...
  "knowledge.page.root": "知識庫",
  "knowledge.page.dataset": "知識庫文件",
  "knowledge.page.document": "文件分段",
  "knowledge.page.placeholder": "知識庫瀏覽入口已接通，下一步會落資料集、文件和分段頁面。",
  "knowledge.page.rootReady": "瀏覽知識庫資料集，並依分類、文件、分段逐層查看。",
  "knowledge.page.datasetReady": "瀏覽目前資料集的分類與文件。",
  "knowledge.page.documentReady": "瀏覽目前文件的分段內容。",
  "knowledge.page.datasetsReady": "共 {{count}} 個知識庫。",
  "knowledge.nav.exit": "退出知識庫",
  "knowledge.loading.datasets": "正在載入知識庫...",
  "knowledge.client.pick": "檢測到多個 MaxKB client，請先選擇一個再載入資料集。",
  "knowledge.client.multiple": "檢測到 {{count}} 個 MaxKB client。",
  "knowledge.client.label": "MaxKB client",
  "knowledge.client.placeholder": "請選擇 client",
  "knowledge.dataset.emptyDescription": "暫無描述",
  "knowledge.dataset.meta": "{{documents}} 個文件 | {{chars}} 字符",
  "knowledge.documents.categories": "分類",
  "knowledge.documents.searchCategory": "搜尋分類",
  "knowledge.documents.searchDocument": "搜尋文件",
  "knowledge.documents.loadingCategories": "正在載入分類...",
  "knowledge.documents.loadingDocuments": "正在載入文件...",
  "knowledge.documents.selectedCategory": "當前分類：{{value}}",
  "knowledge.documents.placeholder": "文件列表和分頁下一步接入，當前已接通分類樹和分類選擇狀態。",
  "knowledge.documents.count": "{{count}} 個文件",
  "knowledge.documents.recordMeta": "{{chars}} 字符 | {{paragraphs}} 個分段",
  "knowledge.documents.empty": "暫無文件。",
  "knowledge.documents.loadMore": "載入更多",
  "knowledge.paragraphs.search": "搜尋已載入分段",
  "knowledge.paragraphs.loading": "正在載入分段...",
  "knowledge.paragraphs.count": "{{count}} 個分段",
  ...
  "sidebar.gettingStarted.line1": "WisCode 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 WisCode 伺服器。",
  ...
  "settings.general.row.language.description": "變更 WisCode 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 WisCode 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 WisCode 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 WisCode 的主題。",
  ...
  "settings.updates.row.startup.description": "在 WisCode 啟動時自動檢查更新",
