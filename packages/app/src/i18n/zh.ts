...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "WisCode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 WisCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 WisCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 WisCode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 wiscode.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 WisCode 服务器。",
  ...
  "toast.update.description": "WisCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 WisCode 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (wiscode.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: WisCode 暂不支持 MCP 认证。',
  ...
  "knowledge.page.root": "知识库",
  "knowledge.page.dataset": "知识库文档",
  "knowledge.page.document": "文档分段",
  "knowledge.page.placeholder": "知识库浏览入口已接通，下一步会落数据集、文档和分段页面。",
  "knowledge.page.rootReady": "浏览知识库数据集，并按分类、文档、分段逐级查看。",
  "knowledge.page.datasetReady": "浏览当前数据集的分类与文档。",
  "knowledge.page.documentReady": "浏览当前文档的分段内容。",
  "knowledge.page.datasetsReady": "共 {{count}} 个知识库。",
  "knowledge.nav.exit": "退出知识库",
  "knowledge.loading.datasets": "正在加载知识库...",
  "knowledge.client.pick": "检测到多个 MaxKB client，请先选择一个再加载数据集。",
  "knowledge.client.multiple": "检测到 {{count}} 个 MaxKB client。",
  "knowledge.client.label": "MaxKB client",
  "knowledge.client.placeholder": "请选择 client",
  "knowledge.dataset.emptyDescription": "暂无描述",
  "knowledge.dataset.meta": "{{documents}} 个文档 | {{chars}} 字符",
  "knowledge.documents.categories": "分类",
  "knowledge.documents.searchCategory": "搜索分类",
  "knowledge.documents.searchDocument": "搜索文档",
  "knowledge.documents.loadingCategories": "正在加载分类...",
  "knowledge.documents.loadingDocuments": "正在加载文档...",
  "knowledge.documents.selectedCategory": "当前分类：{{value}}",
  "knowledge.documents.placeholder": "文档列表和分页下一步接入，当前已接通分类树和分类选择状态。",
  "knowledge.documents.count": "{{count}} 个文档",
  "knowledge.documents.recordMeta": "{{chars}} 字符 | {{paragraphs}} 个分段",
  "knowledge.documents.empty": "暂无文档。",
  "knowledge.documents.loadMore": "加载更多",
  "knowledge.paragraphs.search": "搜索已加载分段",
  "knowledge.paragraphs.loading": "正在加载分段...",
  "knowledge.paragraphs.count": "{{count}} 个分段",
  ...
  "sidebar.gettingStarted.line1": "WisCode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 WisCode 服务器。",
  ...
  "settings.general.row.language.description": "更改 WisCode 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 WisCode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 WisCode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 WisCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 WisCode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 WisCode。",
