export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by WisCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in WisCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in WisCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in WisCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in wiscode.json",
  ...
  "dialog.server.description": "Switch which WisCode server this app connects to.",
  ...
  "toast.update.description": "A new version of WisCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the WisCode team",
  ...
  "error.chain.checkConfig": "Check your config (wiscode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, WisCode does not support MCP authentication yet.',
  ...
  "knowledge.page.root": "Knowledge",
  "knowledge.page.dataset": "Knowledge documents",
  "knowledge.page.document": "Document paragraphs",
  "knowledge.page.placeholder": "Knowledge browser is connected. Dataset, document, and paragraph views will land next.",
  "knowledge.page.rootReady": "Browse knowledge datasets and drill down by category, document, and paragraph.",
  "knowledge.page.datasetReady": "Browse categories and documents in this dataset.",
  "knowledge.page.documentReady": "Browse paragraphs for the selected document.",
  "knowledge.page.datasetsReady": "{{count}} datasets available.",
  "knowledge.nav.exit": "Exit knowledge",
  "knowledge.loading.datasets": "Loading datasets...",
  "knowledge.client.pick": "Multiple MaxKB clients detected. Pick one before loading datasets.",
  "knowledge.client.multiple": "{{count}} MaxKB clients detected.",
  "knowledge.client.label": "MaxKB client",
  "knowledge.client.placeholder": "Select a client",
  "knowledge.dataset.emptyDescription": "No description",
  "knowledge.dataset.meta": "{{documents}} docs | {{chars}} chars",
  "knowledge.documents.categories": "Categories",
  "knowledge.documents.searchCategory": "Search categories",
  "knowledge.documents.searchDocument": "Search documents",
  "knowledge.documents.loadingCategories": "Loading categories...",
  "knowledge.documents.loadingDocuments": "Loading documents...",
  "knowledge.documents.selectedCategory": "Selected category: {{value}}",
  "knowledge.documents.placeholder": "Document list and paging land next. Category tree and selection state are ready.",
  "knowledge.documents.count": "{{count}} documents",
  "knowledge.documents.recordMeta": "{{chars}} chars | {{paragraphs}} paragraphs",
  "knowledge.documents.empty": "No documents found.",
  "knowledge.documents.loadMore": "Load more",
  "knowledge.paragraphs.search": "Search loaded paragraphs",
  "knowledge.paragraphs.loading": "Loading paragraphs...",
  "knowledge.paragraphs.count": "{{count}} paragraphs",
  ...
  "sidebar.gettingStarted.line1": "WisCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "WisCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the WisCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for WisCode",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how WisCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether WisCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how WisCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when WisCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of WisCode.",
