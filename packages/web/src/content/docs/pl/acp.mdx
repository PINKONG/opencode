---
title: ACP
description: Używanie WisCode z protokołem Agent Client Protocol (ACP).
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

WisCode obsługuje [Agent Client Protocol](https://agentclientprotocol.com) (ACP), który umożliwia korzystanie z WisCode bezpośrednio w edytorach i środowiskach IDE.
...
Aby używać WisCode przez ACP, skonfiguruj swój edytor tak, aby uruchamiał polecenie `wiscode acp`.

Uruchamia to WisCode jako podproces zgodny z ACP, który komunikuje się z edytorem za pomocą JSON-RPC przez stdio.
...
Następnie wybierz „WisCode” w selektorze agentów AI Chat.
...
Aby używać WisCode jako agenta ACP w [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodaj następującą konfigurację do Neovim:
...
Ta konfiguracja sprawia, że CodeCompanion używa WisCode jako agenta ACP do czatu.
...
WisCode działa przez ACP tak samo, jak w terminalu. Obsługiwane są wszystkie główne funkcje:
...
- Serwery MCP zdefiniowane w konfiguracji WisCode
