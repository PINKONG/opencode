---
title: IDE
description: Rozszerzenie WisCode dla VS Code, Cursor i innych IDE
---

WisCode integruje się z VS Code, Cursorem lub obsługującym terminal IDE. Aby uruchomić, po prostu uruchom `wiscode` w terminalu.

---

## Stosowanie

- **Szybkie uruchomienie**: użycie `Cmd+Esc` (Mac) lub `Ctrl+Esc` (Windows/Linux), aby uruchomić WisCode w uruchamianiu terminala lub skoncentruj się na uruchamianiu terminala, jeśli jest już uruchomiony.
- **Nowa sesja**: `Cmd+Shift+Esc` (Mac) lub `Ctrl+Shift+Esc` (Windows/Linux), aby została nowa konfiguracja terminala WisCode, nawet jeśli jest już otwarta. Możesz także kliknąć przycisk WisCode w interfejsie użytkownika.
...
Aby poznać WisCode na VS Code w forkach, takich jak Cursor, Windsurf, VSCodium:

1. Otwórz kod VS
2. Otwórz innowacyjny terminal
3. Uruchom `wiscode` — rozszerzenie instaluje się automatycznie
...
Wyszukaj **WisCode** na rynku rozszerzonym i kliknij **Zainstaluj**.
...
- zastosowanie się, że użycie `wiscode` w terminalu.
