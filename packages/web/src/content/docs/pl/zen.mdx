---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez WisCode.
---
...
WisCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół WisCode.

:::note
WisCode Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w WisCode. Logujesz się do WisCode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z WisCode.
:::
...
WisCode Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

WisCode Zen działa jak każdy inny dostawca w WisCode.

1. Logujesz się do **<a href={console}>WisCode Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz WisCode Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji WisCode używa formatu
...
- MiniMax M2.5 Free jest dostępny w WisCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo V2 Pro Free jest dostępny w WisCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo V2 Omni Free jest dostępny w WisCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Qwen3.6 Plus Free jest dostępny w WisCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Super Free jest dostępny w WisCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w WisCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w WisCode także dowolnego innego dostawcy.
