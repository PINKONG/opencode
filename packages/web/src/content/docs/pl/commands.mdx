...
Utwórz `.wiscode/commands/test.md`:
...
Możesz zdefiniować polecenia w `wiscode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji WisCode:
...
- Globalnie: `~/.config/wiscode/commands/`
- Na projekt: `.wiscode/commands/`
...
WisCode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
