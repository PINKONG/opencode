...
WisCode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie WisCode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI WisCode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Jest to oddzielny plik od `wiscode.json`, który konfiguruje zachowanie serwera/runtime.
