---
title: ACP podrška
description: Koristite WisCode u bilo kojem uređivaču kompatibilnom sa ACP.
---

WisCode podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili WisCode putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `wiscode acp`.

Naredba pokreće WisCode kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "WisCode" agenta u AI Chat agent selektoru.
...
Da koristite WisCode kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi WisCode kao ACP chat agenta.
...
WisCode radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj WisCode konfiguraciji
