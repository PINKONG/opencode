---
title: TUI
description: Korištenje korisničkog interfejsa WisCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

WisCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje WisCode pokreće TUI za trenutni direktorij.
...
Kada koristite WisCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u WisCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz WisCode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `wiscode.json`, koji konfiguriše ponašanje servera/izvršavanja.
