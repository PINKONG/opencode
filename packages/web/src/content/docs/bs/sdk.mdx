---
title: SDK
description: Type-safe JS klijent za WisCode server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

WisCode JS/TS SDK pruza type-safe klijent za interakciju sa serverom.
...
Mozete proslijediti konfiguracijski objekat za prilagodavanje ponasanja. Instanca i dalje ucitava `wiscode.json`, ali konfiguraciju mozete nadjacati ili dodati inline:
...
Ako vec imate pokrenutu WisCode instancu, mozete napraviti klijentsku instancu i povezati se na nju:
