...
Kreiraj `.wiscode/commands/test.md`:
...
Možete dodati prilagođene komande kroz WisCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom WisCode [config](/docs/config):
...
- Globalno: `~/.config/wiscode/commands/`
- Po projektu: `.wiscode/commands/`
...
WisCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
