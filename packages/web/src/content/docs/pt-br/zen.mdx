...
O Zen funciona como qualquer outro provedor no WisCode. Você faz login no OpenCode Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o WisCode.
...
O OpenCode Zen funciona como qualquer outro provedor no WisCode.
