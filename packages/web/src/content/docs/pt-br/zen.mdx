---
title: Zen
description: Lista selecionada de modelos fornecidos pelo WisCode.
---
...
O WisCode Zen é uma lista de modelos testados e verificados fornecidos pela equipe do WisCode.

:::note
O WisCode Zen está atualmente em beta.
:::

O Zen funciona como qualquer outro provedor no WisCode. Você faz login no WisCode Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o WisCode.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o WisCode.
:::
...
O WisCode Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O WisCode Zen funciona como qualquer outro provedor no WisCode.

1. Você faz login no **<a href={console}>WisCode Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona WisCode Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do WisCode usa o formato `opencode/<model-id>`. Por exemplo, para GPT 5.3 Codex, você usaria `opencode/gpt-5.3-codex` na sua configuração.
...
- MiniMax M2.5 Free está disponível no WisCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo V2 Pro Free está disponível no WisCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo V2 Omni Free está disponível no WisCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Qwen3.6 Plus Free está disponível no WisCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Super Free está disponível no WisCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no WisCode por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o WisCode também.
