...
O comando `mcp auth` abrirá seu navegador para autorização. Após você autorizar, o WisCode armazenará os tokens de forma segura em `~/.local/share/opencode/mcp-auth.json`.
