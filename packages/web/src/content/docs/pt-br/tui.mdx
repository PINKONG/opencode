...
O WisCode fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar WisCode inicia o TUI para o diretório atual.
...
Ao usar o TUI do WisCode, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Isso é separado do `wiscode.json`, que configura o comportamento do servidor/runtime.
