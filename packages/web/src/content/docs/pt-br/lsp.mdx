...
description: O WisCode integra-se aos seus servidores LSP.
---

O WisCode integra-se ao seu Protocolo de Servidor de Linguagem (LSP) para ajudar o LLM a interagir com sua base de código. Ele usa diagnósticos para fornecer feedback ao LLM.

---

## Integrados

O WisCode vem com vários servidores LSP integrados para linguagens populares:
...
Quando o WisCode abre um arquivo, ele:
