...
Kommandoen `mcp auth` åpner nettleseren din for autorisasjon. Etter at du har godkjent, vil WisCode lagre tokens sikkert i `~/.local/share/opencode/mcp-auth.json`.
