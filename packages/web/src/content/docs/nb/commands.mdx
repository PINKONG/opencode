...
Opprett `.wiscode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom WisCode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i WisCode [config](/docs/config):
...
WisCode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
