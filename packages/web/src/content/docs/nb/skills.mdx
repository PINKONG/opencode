...
Agentferdigheter lar WisCode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går WisCode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
WisCode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `wiscode.json`:
