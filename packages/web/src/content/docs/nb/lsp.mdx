---
title: LSP-servere
description: WisCode integreres med LSP-serverne dine.
---

WisCode integreres med din Language Server Protocol (LSP) for å hjelpe LLM med å samhandle med kodebasen din. Den bruker diagnostikk for å gi tilbakemelding til LLM.

---

## Innebygde servere

WisCode kommer med flere innebygde LSP-servere for populære språk:
...
Når WisCode åpner en fil, gjør den:
...
Du kan tilpasse LSP-servere gjennom `lsp`-delen i WisCode-konfigurasjonen.
