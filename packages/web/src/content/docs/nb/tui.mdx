...
WisCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre WisCode starter TUI for gjeldende katalog.
...
Når du bruker WisCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til WisCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt WisCode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `wiscode.json`, som konfigurerer server-/kjøretidsoppførsel.
