---
title: ACP-støtte
description: Bruk WisCode i en hvilken som helst ACP-kompatibel editor.
---

WisCode støtter [Agent Client Protocol](https://agentclientprotocol.com) eller (ACP), slik at du kan bruke den direkte i kompatible editorer og IDE-er.
...
For å bruke WisCode via ACP, konfigurer redigeringsprogrammet til å kjøre kommandoen `wiscode acp`.

Kommandoen starter WisCode som en ACP-kompatibel underprosess som kommuniserer med editoren din over JSON-RPC via stdio.
...
For å åpne den, bruk den nye 'WisCode'-agenten i AI Chat-agentvelgeren.
...
For å bruke WisCode som en ACP-agent i [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), legg til følgende i Neovim-konfigurasjonen:
...
Denne konfigurasjonen setter opp CodeCompanion.nvim til å bruke WisCode som ACP-agent for chat.
...
WisCode fungerer på samme måte via ACP som i terminalen. Alle funksjoner støttes:
...
- MCP servere konfigurert i WisCode-konfigurasjonen
