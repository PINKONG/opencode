---
title: Zen
description: Utvalgt liste over modeller levert av WisCode.
---
...
WisCode Zen er en liste over testede og verifiserte modeller levert av WisCode-teamet.

:::note
WisCode Zen er for øyeblikket i beta.
:::

Zen fungerer som enhver annen leverandør i WisCode. Du logger inn på WisCode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med WisCode.
:::
...
WisCode Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

WisCode Zen fungerer som enhver annen leverandør i WisCode.

1. Du logger inn på **<a href={console}>WisCode Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger WisCode Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i WisCode-konfigurasjonen din
...
- MiniMax M2.5 Free er tilgjengelig på WisCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo V2 Pro Free er tilgjengelig på WisCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo V2 Omni Free er tilgjengelig på WisCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Qwen3.6 Plus Free er tilgjengelig på WisCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Super Free er tilgjengelig på WisCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på WisCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet WisCode Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med WisCode også.
