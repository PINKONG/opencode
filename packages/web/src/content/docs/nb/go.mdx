...
WisCode Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

:::note
WisCode Go er for øyeblikket i beta.
:::

Go fungerer som enhver annen leverandør i WisCode. Du abonnerer på WisCode Go og
...
WisCode Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

WisCode Go fungerer som enhver annen leverandør i WisCode.

1. Du logger inn på **<a href={console}>WisCode Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `WisCode Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på WisCode Go.
:::
...
WisCode Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din WisCode-konfigurasjon
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med WisCode også.
