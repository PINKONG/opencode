---
title: Share
description: Share your WisCode conversations.
---

WisCode's share feature allows you to create public links to your WisCode conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, WisCode:
...
WisCode supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, WisCode uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `wiscode.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using WisCode in your organization.
