...
Il campo di input del prompt nell'app desktop di WisCode supporta scorciatoie comuni in stile Readline/Emacs per modificare il testo. Sono integrate e al momento non configurabili tramite `wiscode.json`.
