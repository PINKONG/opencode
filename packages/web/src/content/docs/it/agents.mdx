...
L'ID modello nella configurazione WisCode usa il formato `provider/model-id`. Per esempio, se stai usando [WisCode Zen](/docs/zen), useresti `opencode/gpt-5.1-codex` per GPT 5.1 Codex.
