...
Il comando `mcp auth` aprira' il browser per l'autorizzazione. Dopo l'autorizzazione, WisCode memorizzera' i token in modo sicuro in `~/.local/share/opencode/mcp-auth.json`.
