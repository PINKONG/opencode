---
title: Zen
description: Lista curata di modelli fornita da WisCode.
---
...
WisCode Zen è un elenco di modelli testati e verificati forniti dal team di WisCode.

:::note
WisCode Zen è attualmente in beta.
:::

Zen funziona come qualsiasi altro provider in WisCode. Accedi a WisCode Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con WisCode.
:::
...
WisCode Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

WisCode Zen funziona come qualsiasi altro provider in WisCode.

1. Accedi a **<a href={console}>WisCode Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona WisCode Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di WisCode
...
- MiniMax M2.5 Free è disponibile su WisCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo V2 Pro Free è disponibile su WisCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo V2 Omni Free è disponibile su WisCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Qwen3.6 Plus Free è disponibile su WisCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Super Free è disponibile su WisCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su WisCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato WisCode Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con WisCode.
