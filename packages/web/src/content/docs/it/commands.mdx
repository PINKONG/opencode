...
Puoi aggiungere comandi personalizzati tramite la config di WisCode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di WisCode:
...
- Globale: `~/.config/wiscode/commands/`
- Per progetto: `.wiscode/commands/`
...
WisCode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
