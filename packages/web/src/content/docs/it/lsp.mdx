---
title: Server LSP
description: WisCode si integra con i tuoi server LSP.
---

WisCode si integra con il tuo Language Server Protocol (LSP) per aiutare l'LLM a interagire con la tua codebase. Usa le diagnostiche per fornire feedback all'LLM.

---

## Integrati

WisCode include diversi server LSP integrati per linguaggi popolari:
