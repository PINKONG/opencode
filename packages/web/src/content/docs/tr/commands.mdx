...
`.wiscode/commands/test.md` oluştur:
...
WisCode işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

WisCode [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/wiscode/commands/`
- Proje başına: `.wiscode/commands/`
...
WisCode, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
