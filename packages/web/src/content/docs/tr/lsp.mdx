...
description: WisCode, LSP sunucularınızla bütünleşir.
---

WisCode, LLM'in kod tabanınızla etkileşime girmesine yardımcı olmak için Dil Sunucusu Protokolünüzle (LSP) bütünleşir. LLM'ye geri bildirim sağlamak için tanılamayı kullanır.

---

## Yerleşik

WisCode, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
LSP sunucularını, WisCode yapılandırmanızdaki `lsp` bölümü aracılığıyla özelleştirebilirsiniz.
