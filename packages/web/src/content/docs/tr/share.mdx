---
title: Paylasim
description: WisCode konusmalarini genel baglantilarla paylasin.
---

WisCode'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda WisCode:
...
WisCode, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak WisCode manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `wiscode.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda WisCode kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
