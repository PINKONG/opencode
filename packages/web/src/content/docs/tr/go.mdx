...
Go, WisCode'daki diğer sağlayıcılar gibi çalışır. OpenCode Go'ya abone olur ve API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve WisCode'u kullanmak için bunu kullanmanıza gerek yoktur.
...
OpenCode Go, WisCode'daki diğer sağlayıcılar gibi çalışır.
...
| ------------------ | ------- | ----- | --------- | ----------- | ------------ | ------------ | ------------ | ------------ | ------------ |
| 5 saatte bir istek | 880     | 1.150 | 1.850     | 1.290       | 2.150        | 14.000       | 20.000       | 3,300        | 10,200       |
| haftalık istek     | 2.150   | 2.880 | 4.630     | 3.225       | 5.450        | 35.000       | 50.000       | 8,200        | 25,200       |
| aylık istek        | 4.300   | 5.750 | 9.250     | 6.450       | 10.900       | 70.000       | 100.000      | 20,500       | 50,500       |
