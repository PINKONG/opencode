---
title: TUI
description: Arbeite mit WisCode in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

WisCode bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet WisCode die TUI im aktuellen Verzeichnis.
...
In der WisCode-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu WisCode hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet WisCode. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `wiscode.json`, welche das Server-/Runtime-Verhalten konfiguriert.
