...
Die Eingabeaufforderungseingabe der WisCode-Desktop-App unterstützt gängige Readline/Emacs-style-Verknüpfungen zum Bearbeiten von Text. Diese sind integriert und derzeit nicht über `wiscode.json` konfigurierbar.
