...
Zen funktioniert wie jeder andere Provider in WisCode. Du meldest dich bei OpenCode Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um WisCode zu nutzen.
...
OpenCode Zen funktioniert wie jeder andere Provider in WisCode.
