---
title: Zen
description: Kuratierte Modellliste direkt von WisCode.
---
...
WisCode Zen ist eine Liste von getesteten und verifizierten Modellen, die vom WisCode-Team bereitgestellt wird.

:::note
WisCode Zen befindet sich derzeit in der Beta.
:::

Zen funktioniert wie jeder andere Provider in WisCode. Du meldest dich bei WisCode Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um WisCode zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit WisCode funktionieren.
:::
...
WisCode Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

WisCode Zen funktioniert wie jeder andere Provider in WisCode.

1. Du meldest dich bei **<a href={console}>WisCode Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst WisCode Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner WisCode-Konfiguration verwendet das Format `opencode/<model-id>`. Für GPT 5.3 Codex würdest du zum Beispiel `opencode/gpt-5.3-codex` in deiner Konfiguration verwenden.
...
- MiniMax M2.5 Free ist für begrenzte Zeit auf WisCode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo V2 Pro Free ist für begrenzte Zeit auf WisCode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo V2 Omni Free ist für begrenzte Zeit auf WisCode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Qwen3.6 Plus Free ist für begrenzte Zeit auf WisCode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Super Free ist für begrenzte Zeit auf WisCode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf WisCode verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben WisCode Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit WisCode auch jeden anderen Provider zu verwenden.
