---
title: Teilen
description: Teile WisCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu WisCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht WisCode Folgendes:
...
WisCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt WisCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`wiscode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du WisCode in deiner Organisation einsetzt.
