---
title: LSP Server
description: WisCode lässt sich in Ihren LSP-Server integrieren.
---

WisCode lässt sich in Ihr Language Server Protocol (LSP) integrieren, um die Interaktion von LLM mit Ihrer Codebasis zu unterstützen. Es verwendet Diagnosefunktionen, um dem LLM Feedback zu geben.

---

## Integriert

WisCode verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn WisCode eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer WisCode-Konfiguration anpassen.
