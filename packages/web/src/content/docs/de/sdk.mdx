...
Das WisCode JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und WisCode programmatisch steuern.
...
`wiscode.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn WisCode bereits laeuft, kannst du nur einen Client erstellen und verbinden:
