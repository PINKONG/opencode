...
description: Opret værktøjer, som LLM kan kalde WisCode ind.
---
...
- Lokalt ved at placere dem i biblioteket `.wiscode/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/wiscode/tools/`.
