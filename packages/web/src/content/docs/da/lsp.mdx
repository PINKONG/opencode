---
title: LSP-servere
description: WisCode integreres med dine LSP-servere.
---

WisCode integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

WisCode leveres med flere indbyggede LSP-servere til populære sprog:
...
Når WisCode åbner en fil, vil den:
