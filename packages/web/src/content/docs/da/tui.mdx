---
title: TUI
description: Brug af WisCode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

WisCode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre WisCode starter TUI for den nuværende mappe.
...
Når du bruger WisCode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til WisCode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut WisCode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `wiscode.json`, som konfigurerer server-/kørselstidsadfærd.
