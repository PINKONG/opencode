...
Model-id'et i din WisCode-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [WisCode Zen](/docs/zen), vil du bruge `opencode/gpt-5.1-codex` til GPT 5.1 Codex.
