...
Der er to typer agenter i WisCode; primære agenter og subagenter.
...
WisCode leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
WisCode leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

WisCode leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Konfigurer agent i din `wiscode.json`-konfigurationsfil:
...
Hvis ingen temperatur er angivet, bruger WisCode modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale WisCode-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din WisCode-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [OpenCode Zen](/docs/zen), vil du bruge `opencode/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `wiscode models` for at se en liste over de tilgængelige modeller.
:::
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/PINKONG/opencode).
:::
