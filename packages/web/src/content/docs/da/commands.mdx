...
Opret `.wiscode/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem WisCode-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din WisCode [config](/docs/config):
...
- Globalt: `~/.config/wiscode/commands/`
- Pr. projekt: `.wiscode/commands/`
...
WisCode indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
