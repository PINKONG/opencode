...
Brug den til at bygge integrasjoner og kontrollere WisCode programmatisk.
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `wiscode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av WisCode, kan du oprete en klientforekomst for at koble til den:
