---
title: Zen
description: Udvalgt liste over modeller leveret af WisCode.
---
...
WisCode Zen er en liste over testede og verificerede modeller leveret af WisCode-teamet.

:::note
WisCode Zen er i øjeblikket i beta.
:::

Zen fungerer som enhver anden udbyder i WisCode. Du logger ind på WisCode Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med WisCode.
:::
...
WisCode Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

WisCode Zen fungerer som enhver anden udbyder i WisCode.

1. Du logger ind på **<a href={console}>WisCode Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger WisCode Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din WisCode-konfiguration
...
- MiniMax M2.5 Free er tilgængelig på WisCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo V2 Pro Free er tilgængelig på WisCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo V2 Omni Free er tilgængelig på WisCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Qwen3.6 Plus Free er tilgængelig på WisCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Super Free er tilgængelig på WisCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på WisCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med WisCode også.
