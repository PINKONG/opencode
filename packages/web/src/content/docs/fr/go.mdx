...
Go fonctionne comme n'importe quel autre fournisseur dans WisCode. Vous vous abonnez à OpenCode Go et obtenez votre clé d'API. C'est **totalement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser WisCode.
...
OpenCode Go fonctionne comme n'importe quel autre fournisseur dans WisCode.
...
| --------------------- | ------- | ----- | --------- | ----------- | ------------ | ------------ | ------------ | ------------ | ------------ |
| requêtes par 5 heures | 880     | 1,150 | 1,850     | 1,290       | 2,150        | 14,000       | 20,000       | 3,300        | 10,200       |
| requêtes par semaine  | 2,150   | 2,880 | 4,630     | 3,225       | 5,450        | 35,000       | 50,000       | 8,200        | 25,200       |
| requêtes par mois     | 4,300   | 5,750 | 9,250     | 6,450       | 10,900       | 70,000       | 100,000      | 20,500       | 50,500       |
