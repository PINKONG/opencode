---
title: Zen
description: Liste organisée de modèles fournis par WisCode.
---
...
WisCode Zen est une liste de modèles testés et vérifiés fournie par l'équipe WisCode.

:::note
WisCode Zen est actuellement en version bêta.
:::

Zen fonctionne comme n'importe quel autre fournisseur dans WisCode. Vous vous connectez à WisCode Zen et obtenez votre clé API. C'est **entièrement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser WisCode.
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec WisCode.
:::
...
WisCode Zen est une passerelle AI qui vous donne accès à ces modèles.

---

## Comment ça marche

WisCode Zen fonctionne comme n'importe quel autre fournisseur dans WisCode.

1. Vous vous connectez à **<a href={console}>WisCode Zen</a>**, ajoutez vos informations de facturation et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez WisCode Zen et collez votre clé API.
...
Le [model id](/docs/config/#models) dans votre configuration WisCode utilise le format `opencode/<model-id>`. Par exemple, pour GPT 5.3 Codex, vous utiliseriez `opencode/gpt-5.3-codex` dans votre configuration.
...
- MiniMax M2.5 Free est disponible sur WisCode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- MiMo V2 Pro Free est disponible sur WisCode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- MiMo V2 Omni Free est disponible sur WisCode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Qwen3.6 Plus Free est disponible sur WisCode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Nemotron 3 Super Free est disponible sur WisCode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Big Pickle est un modèle stealth gratuit sur WisCode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
Nous avons créé WisCode Zen pour :
...
4. N'avoir **aucun lock-in** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et toujours vous permettre d'utiliser n'importe quel autre fournisseur avec WisCode également.
