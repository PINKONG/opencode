...
Zen fonctionne comme n'importe quel autre fournisseur dans WisCode. Vous vous connectez à OpenCode Zen et obtenez votre clé API. C'est **entièrement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser WisCode.
...
OpenCode Zen fonctionne comme n'importe quel autre fournisseur dans WisCode.
