---
title: Serveurs LSP
description: WisCode s'intègre à vos serveurs LSP.
---

WisCode s'intègre via le protocole LSP (Language Server Protocol) pour aider le LLM à interagir avec votre base de code. Il utilise des diagnostics pour fournir des commentaires au LLM.

---

## Serveurs intégrés

WisCode est livré avec plusieurs serveurs LSP intégrés pour les langages populaires :
...
Lorsque WisCode ouvre un fichier, il :
