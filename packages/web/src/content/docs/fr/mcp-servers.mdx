...
La commande `mcp auth` ouvrira votre navigateur pour autorisation. Après votre autorisation, WisCode stockera les jetons en toute sécurité dans `~/.local/share/opencode/mcp-auth.json`.
