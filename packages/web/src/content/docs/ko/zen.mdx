...
Zen은 WisCode의 다른 provider와 똑같이 작동합니다. OpenCode Zen에 로그인해 API 키를 받으면 됩니다. 이는 **완전히 선택 사항**이며, WisCode를 사용하기 위해 반드시 사용할 필요는 없습니다.
...
OpenCode Zen은 WisCode의 다른 provider와 똑같이 작동합니다.
