...
Crear `.wiscode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración WisCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su WisCode [config](/docs/config):
...
WisCode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
