...
El comando `mcp auth` abrirá su navegador para obtener autorización. Después de su autorización, WisCode almacenará los tokens de forma segura en `~/.local/share/opencode/mcp-auth.json`.
