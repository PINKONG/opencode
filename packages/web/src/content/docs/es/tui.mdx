---
title: TUI
description: Usando la interfaz de usuario del terminal WisCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

WisCode proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar WisCode se inicia TUI para el directorio actual.
...
Cuando utilice WisCode TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a WisCode. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de WisCode. _Alias_: `/quit`, `/q`
...
Esto es independiente de `wiscode.json`, que configura el comportamiento del servidor/tiempo de ejecución.
