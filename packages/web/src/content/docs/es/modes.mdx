...
Los modos en WisCode le permiten personalizar el comportamiento, las herramientas y las indicaciones para diferentes casos de uso.
...
WisCode viene con dos modos integrados.
...
- `edit` - No se pueden modificar archivos existentes, excepto los archivos ubicados en `.wiscode/plans/*.md` para detallar el plan en sí.
...
Configure los modos en su archivo de configuración `wiscode.json`:
...
tanto la configuración global WisCode como la configuración específica del proyecto.
...
Cree archivos de modo en `.wiscode/modes/` para modos específicos del proyecto o `~/.config/wiscode/modes/` para modos globales:
