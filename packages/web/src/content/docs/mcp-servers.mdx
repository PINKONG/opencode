...
The `mcp auth` command will open your browser for authorization. After you authorize, WisCode will store the tokens securely in `~/.local/share/opencode/mcp-auth.json`.
