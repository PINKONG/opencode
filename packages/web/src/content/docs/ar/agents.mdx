...
يستخدم معرّف النموذج في إعدادات WisCode الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [WisCode Zen](/docs/zen)، فستستخدم `opencode/gpt-5.1-codex` لـ GPT 5.1 Codex.
