...
يوجد نوعان من الوكلاء في WisCode: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي WisCode مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي WisCode مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي WisCode مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `wiscode.json`:
...
- عام: `~/.config/wiscode/agents/`
- لكل مشروع: `.wiscode/agents/`
...
إذا لم يتم تحديد temperature، يستخدم WisCode القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات WisCode العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات WisCode الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [OpenCode Zen](/docs/zen)، فستستخدم `opencode/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `wiscode models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/PINKONG/opencode).
:::
