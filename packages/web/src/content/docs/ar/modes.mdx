...
تتيح لك الأوضاع في WisCode تخصيص السلوك والأدوات والمطالبات لحالات استخدام مختلفة.
...
- `edit` - لا يمكن تعديل الملفات الموجودة، باستثناء الملفات الموجودة في `.wiscode/plans/*.md` لتفصيل الخطة نفسها
...
قم بإعداد الأوضاع في ملف الإعدادات `wiscode.json` لديك:
...
- عالمي: `~/.config/wiscode/modes/`
- للمشروع: `.wiscode/modes/`
...
إذا لم يتم تحديد درجة الحرارة، يستخدم WisCode القيم الافتراضية الخاصة بكل نموذج (عادةً 0 لمعظم النماذج و 0.55 لنماذج Qwen).
...
إعدادات WisCode العالمية وكذلك إعدادات المشروع.
...
أنشئ ملفات الأوضاع في `.wiscode/modes/` لأوضاع خاصة بالمشروع أو في `~/.config/wiscode/modes/` لأوضاع عالمية:
