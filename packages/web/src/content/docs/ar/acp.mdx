---
title: دعم ACP
description: استخدم WisCode في أي محرر متوافق مع ACP.
---

يدعم WisCode بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام WisCode عبر ACP، اضبط محررك ليشغّل الأمر `wiscode acp`.

يشغّل هذا الأمر WisCode كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'WisCode' من محدد الوكلاء في AI Chat.
...
لاستخدام WisCode كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام WisCode كوكيل ACP للدردشة.
...
يعمل WisCode عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات WisCode
