...
สร้าง `.wiscode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ WisCode:
...
- ระดับผู้ใช้ (Global): `~/.config/wiscode/commands/`
- ระดับโปรเจ็กต์: `.wiscode/commands/`
...
WisCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
