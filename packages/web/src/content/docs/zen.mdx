---
title: Zen
description: Curated list of models provided by WisCode.
---
...
WisCode Zen is a list of tested and verified models provided by the WisCode team.

:::note
WisCode Zen is currently in beta.
:::

Zen works like any other provider in WisCode. You login to WisCode Zen and get
...
:::tip
We tested a select group of models and providers that work well with WisCode.
:::
...
WisCode Zen is an AI gateway that gives you access to these models.

---

## How it works

WisCode Zen works like any other provider in WisCode.

1. You sign in to **<a href={console}>WisCode Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select WisCode Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your WisCode config
...
- MiniMax M2.5 Free is available on WisCode for a limited time. The team is using this time to collect feedback and improve the model.
- Qwen3.6 Plus Free is available on WisCode for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Super Free is available on WisCode for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on WisCode for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with WisCode as well.
