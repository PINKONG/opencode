...
# Menedżery pakietów
npm i -g wiscode-ai@latest        # albo bun/pnpm/yarn
...
WisCode jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/anomalyco/opencode/releases) lub z [opencode.ai/download](https://opencode.ai/download).
...
WisCode zawiera dwóch wbudowanych agentów, między którymi możesz przełączać się klawiszem `Tab`.
...
Więcej informacji o konfiguracji WisCode znajdziesz w [**dokumentacji**](https://opencode.ai/docs).

### Współtworzenie

Jeśli chcesz współtworzyć WisCode, przeczytaj [contributing docs](./CONTRIBUTING.md) przed wysłaniem pull requesta.
