...
<p align="center">WisCode je open source AI agent za programiranje.</p>
<p align="center">
...
# Package manageri
npm i -g wiscode-ai@latest        # ili bun/pnpm/yarn
...
WisCode je dostupan i kao desktop aplikacija. Preuzmi je direktno sa [stranice izdanja](https://github.com/anomalyco/opencode/releases) ili sa [opencode.ai/download](https://opencode.ai/download).
...
WisCode uključuje dva ugrađena agenta između kojih možeš prebacivati tasterom `Tab`.
...
Za više informacija o konfiguraciji WisCode-a, [**pogledaj dokumentaciju**](https://opencode.ai/docs).

### Doprinosi

Ako želiš doprinositi WisCode-u, pročitaj [upute za doprinošenje](./CONTRIBUTING.md) prije slanja pull requesta.
